...
public class ContentServer 
{
    ...
    public void put(int p, Content content)
    {
        ...
        try
        {
            ...
            Request request = new Request(this.logicalClock, this.contentServer_ID, "put request"); //sending request, ID and logical clock
    ...
    //helper method to send messages and return the response message from AS
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        if(ID < 1)
        {
            System.out.println("please use an ID that is greater than 0");
        }
        else
        {
            c1.contentServer_ID = ID;
